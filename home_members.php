                    ...
                    <table class="table table-bordered table-hover table-condensed" id="myTable">
                      ...
                      <?php
                        ...
                        while($row = mysqli_fetch_array($res,MYSQLI_ASSOC))
                        {
                          ?>
                          <tr>
                          <td><p align="center"><?php echo $row['name']; ?></p></td> 
                          <td><p align="center"><?php echo $row['house_no']; ?></p></td> 
                          <td><p align="center"><?php echo $row['email']; ?></p></td> 
                          <td><p align="center"><?php echo $row['phone']; ?></p></td> 
                           <td align="center">
                            <a class="btn btn-primary" href="view_member.php?member_id=<?php echo $row['member_id']; ?>">View</a>
                            <a class="btn btn-danger" href="delete_member.php?member_id=<?php echo $row['member_id']; ?>">Delete</a>
                            <button type="button" data-toggle="modal" data-target="#updateMember" class="btn btn-success">Update</button>
                          </td>
                        </tr>
                          <?php
                        }
