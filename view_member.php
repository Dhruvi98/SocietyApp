      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li>
              <a href="event_notice.php">Event/Notice</a>
            </li>
            <li>
        ...
        <br>
          <div class="well bs-component">
            ...
            <div class="modal-header" id="display" style="padding:20px 50px;">
              <a href="home_members.php" type="button" class="close" data-dismiss="modal" title="Close">&times;</a>
